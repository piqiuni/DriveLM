...
class GPTEvaluation:
    def __init__(self):
        openai.api_key = pi_api_key
        openai.base_url = pi_base_url
...
#     output = ""
#     messages = eval.prepare_chatgpt_message(prompts)
#     reply, total_tokens = eval.call_chatgpt(messages, max_tokens=3000)
